...
![image](https://swexpertacademy.com/main/common/fileDownload.do?downloadType=CKEditorImages&fileId=AV5VymrKATcDFAWu)

![image](https://swexpertacademy.com/main/common/fileDownload.do?downloadType=CKEditorImages&fileId=AV5V0GlaAWgDFAWu)
...
dir_x = [1, 1, -1, -1]
dir_y = [1, -1, -1, 1]
def solve(i, j, direction, dessert):
    global answer
    if direction % 4 == 3:
        arrow = direction + 1
    else:
        arrow = direction + 2
    for k in range(direction, arrow):
        new_x = i + dir_x[k]
        new_y = j + dir_y[k]
        ...
        if 0 <= new_x < N and 0 <= new_y < N:
            if visited[new_x][new_y] == 0 and ate[arr[new_x][new_y]] == 0:
                visited[new_x][new_y] = 1
                ate[arr[new_x][new_y]] = 1

                solve(new_x, new_y, k, dessert + 1)

                visited[new_x][new_y] = 0
                ate[arr[new_x][new_y]] = 0
